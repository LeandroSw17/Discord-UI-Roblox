...
function DiscordLib:Window(text)
	...
	MainFrame.ClipsDescendants = true -- Mantém o conteúdo dentro das bordas arredondadas
	MainFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
	MainFrame.Size = UDim2.new(0, 681, 0, 396)

	-- Adiciona o UICorner para arredondar as bordas do MainFrame
	local MainFrameCorner = Instance.new("UICorner")
	MainFrameCorner.CornerRadius = UDim.new(0, 8) -- Raio de 8 pixels. Ajuste conforme necessário.
